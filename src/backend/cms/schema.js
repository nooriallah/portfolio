/**
 * src/backend/cms/schema.js — WHAT THE ADMIN PANEL CAN EDIT.
 *
 ...
 *
 * The admin forms are GENERATED from this file (src/backend/admin-ui/Fields.jsx),
...
// Languages and section ids are shared with the public site, so they live in
// src/shared/config.js. They are re-exported here so backend code can keep
// importing everything CMS-related from this one file.
export { LANGUAGES, DEFAULT_LANG, LANG_CODES, NAV_IDS } from "@shared/config.js";
import { LANG_CODES, NAV_IDS, LANGUAGES, DEFAULT_LANG } from "@shared/config.js";
 ...
 *   table     – the Drizzle table name exported from src/backend/db/schema.js
