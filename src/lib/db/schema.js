/**
 * src/lib/db/schema.js — THE DATABASE SCHEMA (Drizzle ORM, PostgreSQL / Neon).
 *
 * Every table that the admin panel manages is defined here. The public site
 * reads from these tables through `src/lib/cms/content.js`.
 *
 ...
 * The list of keys and their field types lives in src/lib/cms/schema.js.
 * ------------------------------------------------------------------ */
 ...
 * `icon` is a lucide-react icon name, see src/lib/cms/icons.js.
 * ------------------------------------------------------------------ */
 ...
 * `icon` is one of the brand icons in src/lib/cms/icons.js.
 * ------------------------------------------------------------------ */
