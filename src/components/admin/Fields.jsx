"use client";
/**
 * src/components/admin/Fields.jsx — FORM INPUTS FOR THE ADMIN PANEL.
 *
 * `<FieldInput field value error />` renders the right input for a field
 * definition from src/lib/cms/schema.js. Input NAMES follow the convention
 * that src/lib/cms/parse.js reads back (e.g. "title.en", "facts.0.label.fa").
 *
...
import { LUCIDE_ICON_NAMES, BRAND_ICON_NAMES } from "@/lib/cms/icons.js";
